...
class MinecraftApiIncorrectMethod(Exception):
    pass
...
class MinecraftApiResponse:
    def __init__(self, mcjson):
        self.data = mcjson['success']
        self.data_source = mcjson['source']
...
if __name__ == '__main__':
    ...
    client = MinecraftApiWorker('mc.kpostek.pl', '20159')
    task = MinecraftApiTask('admin', 'changeme', 'players.online')
    print(
        yaml.dump(
